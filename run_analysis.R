run_analysis <- function(outcome, num = "best") {
  ...
  DataTest_Y <- read.table("./UCI HAR Dataset/test/subject_test.txt", col.names = "labels")
  
  DataSubject_Test <- read.table("./UCI HAR Dataset/test/y_test.txt", col.names = "Subject")
